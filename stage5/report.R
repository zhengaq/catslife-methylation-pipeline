### stage5/report.R: stage-5 tables (TABLES_DIR) and figures (REPORT_DIR):
### descriptives, clock-vs-age validity, per-clock violin plots, and cross-tissue
### rank corrplots.
...
## cor(..., use="complete.obs") errors when there are no complete pairs, e.g. for
## a clock compute_clocks() had to NA-fill; that clock gets NA.
